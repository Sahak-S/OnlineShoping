package com.example.onlineshoping.db;
...
public class DatabaseConnection {
    ...
    public static Connection getConnection() {
        try {
            ...
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/onlineshoping?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC", "root", "root");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return (connection);
